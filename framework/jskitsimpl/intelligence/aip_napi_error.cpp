...
constexpr ErrCodeMapping NATIVE_ERR_CODE2TS_ERR_CODE[] = {
    ...
    { NATIVE_RAG_E_RETRIEVE_ERROR, RETRIEVAL_E_RECALL_FAILURE },
    { NATIVE_RAG_E_LLM_ERROR, RAG_E_LLM_LOAD_FAILED },
    { NATIVE_RAG_E_EMBEDDING_ERROR, RAG_E_RAG_COMMON_ERROR },
    ...
    { NATIVE_RAG_E_LLM_STREAM_TIMEOUT, RAG_E_LLM_TIMEOUT },
...
constexpr ErrMessage ERROR_MESSAGES [] = {
    ...
    { RAG_E_LLM_BUSY, "A busy failure occurred when calling the LLM." },
    { RAG_E_LLM_OUTPUT_INVALID, "The LLM output is invalid." },
    { RAG_E_RAG_ALREADY_EXISTS, "The RAG session is already exists." },
    { RAG_E_RAG_BUSY, "The RAG session is busy." },
    { RAG_E_RAG_ALREADY_CLOSED, "The RAG session is already closed." },
    { RAG_E_RAG_USER_CANCEL, "The streamRun is canceled by user." },
