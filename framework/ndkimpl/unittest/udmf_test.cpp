 ...
 */
     ...
     * @tc.desc: OH_UdmfData_AddRecord with return UDMF_E_INVAILD_PARAM
     * @tc.type: FUNC
     * @tc.require: AROOOH5R5G
     */
     ...
     * @tc.desc: OH_UdmfData_HasType with return UDMF_E_INVAILD_PARAM
     * @tc.type: FUNC
     * @tc.require: AROOOH5R5G
     */
    ...
    HWTEST_F(UDMFTest, OH_Udmf_AddAndGetGeneralEntry003, TestSize.Level0)
    {
        ...
        EXPECT_EQ(getRes, UDMF_E_INVAILD_PARAM);
