...
/**
* @tc.name: SubscribeUtdChange001
* @tc.desc: Normal testcase of SubscribeUtdChange
* @tc.type: FUNC
*/
HWTEST_F(UtdClientTest, SubscribeUtdChange001, TestSize.Level1)
{
    LOG_INFO(UDMF_TEST, "SubscribeUtdChange001 begin.");
    HapInfoParams info = {
        .userID = 100,
        .bundleName = "ohos.test.demo",
        .instIndex = 0,
    ...
    SetSelfTokenID(tokenID.tokenIDEx);
    UtdClient utdClient;
    utdClient.SubscribeUtdChange();
    EXPECT_EQ(utdClient.subscriber_, nullptr);
    LOG_INFO(UDMF_TEST, "SubscribeUtdChange001 end.");
}
} // OHOS::Test