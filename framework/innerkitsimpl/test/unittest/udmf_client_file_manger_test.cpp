...
void UdmfClientFileMangerTest::CompareDetails(const UDDetails &details)
{
...
void UdmfClientFileMangerTest::ComparePixelMap(const UDDetails details,
    std::shared_ptr<OHOS::Media::PixelMap> pixelMapIn)
{
...
void UdmfClientFileMangerTest::GetFileUriUnifiedData(UnifiedData &data)
{
...
HWTEST_F(UdmfClientFileMangerTest, SetData004, TestSize.Level1)
{
    ...
    QueryOption query1;
    query1.key = "udmf://aaabbbccc/com.hmos.photos/CSl;cdcGFcmdkasaccCSCAAScscdc";
    status = UdmfClient::GetInstance().GetBatchData(query1, unifiedDataSet);
    ASSERT_EQ(status, E_INVALID_PARAMETERS);
...
HWTEST_F(UdmfClientFileMangerTest, SetData013, TestSize.Level1)
{
    ...
    auto status = UdmfClient::GetInstance().SetData(customOption, inputData, key);
    int64_t end = CountTime();
    LOG_INFO(UDMF_TEST, "setdata 1000 cost timet:%{public}" PRIi64, (end - start));
    ASSERT_EQ(status, E_OK);
    ...
    LOG_INFO(UDMF_TEST, "getdata 1000 cost timet:%{public}" PRIi64, (end - start));
    ASSERT_EQ(status, E_OK);
    status = UdmfClient::GetInstance().DeleteData(query, unifiedDataSet);
    ASSERT_EQ(status, E_OK);
...
* @tc.type: FUNC
*/
HWTEST_F(UdmfClientFileMangerTest, SetData022, TestSize.Level1)
{
    LOG_INFO(UDMF_TEST, "SetData002 begin.");
    CustomOption customOption = { .intention = Intention::UD_INTENTION_PICKER };
    UnifiedData inputData;
    ...
    auto status = UdmfClient::GetInstance().SetData(customOption, inputData, keyTest);
    int64_t end = CountTime();
    LOG_INFO(UDMF_TEST, "picker setdata 1000 record cost timet:%{public}" PRIi64, (end - start));
    ASSERT_EQ(status, E_OK);
    ...
    LOG_INFO(UDMF_TEST, "picker getdata 1000 record cost timet:%{public}" PRIi64, (end - start));
    EXPECT_EQ(status, E_OK);
    query.intention = Intention::UD_INTENTION_PICKER;
    status = UdmfClient::GetInstance().GetBatchData(query, unifiedDataSet);
    EXPECT_EQ(status, E_OK);
...
* @tc.type: FUNC
*/
HWTEST_F(UdmfClientFileMangerTest, SetData023, TestSize.Level1)
{
    ...
    auto status = UdmfClient::GetInstance().SetData(customOption, inputData, keyTest);
    int64_t end = CountTime();
    LOG_INFO(UDMF_TEST, "systemshare setdata 1000 record cost timet:%{public}" PRIi64, (end - start));
    ASSERT_EQ(status, E_OK);
    ...
    LOG_INFO(UDMF_TEST, "systemshare getdata 1000 record cost timet:%{public}" PRIi64, (end - start));
    EXPECT_EQ(status, E_OK);
    query.intention = Intention::UD_INTENTION_SYSTEM_SHARE;
    status = UdmfClient::GetInstance().GetBatchData(query, unifiedDataSet);
    EXPECT_EQ(status, E_OK);
...
* @tc.type: FUNC
*/
HWTEST_F(UdmfClientFileMangerTest, SetData024, TestSize.Level1)
{
    ...
    auto status = UdmfClient::GetInstance().SetData(customOption, inputData, keyTest);
    int64_t end = CountTime();
    LOG_INFO(UDMF_TEST, "menu setdata 1000 record cost timet:%{public}" PRIi64, (end - start));
    ASSERT_EQ(status, E_OK);
    ...
    LOG_INFO(UDMF_TEST, "menu getdata 1000 record cost timet:%{public}" PRIi64, (end - start));
    EXPECT_EQ(status, E_OK);
    query.intention = Intention::UD_INTENTION_MENU;
    status = UdmfClient::GetInstance().GetBatchData(query, unifiedDataSet);
    EXPECT_EQ(status, E_OK);
...
HWTEST_F(UdmfClientFileMangerTest, AddPrivilege007, TestSize.Level1)
{
    ...
    query.key = "udmf://aaabbbccc/com.hmos.photos/CSl;cdcGFcmdkasaccCSCAAScscdc";
    status = UdmfClient::GetInstance().AddPrivilege(query, privilege);
    ASSERT_EQ(status, E_NO_PERMISSION);
    query.intention = Intention::UD_INTENTION_MENU;
    status = UdmfClient::GetInstance().AddPrivilege(query, privilege);
...
HWTEST_F(UdmfClientFileMangerTest, DeleteData003, TestSize.Level1)
{
    ...
    QueryOption queryOption;
    std::vector<UnifiedData> unifiedDataSet;
    queryOption.key = "udmf://aaabbbccc/com.hmos.photos/CSl;cdcGFcmdkasaccCSCAAScscdc";
    status = UdmfClient::GetInstance().DeleteData(queryOption, unifiedDataSet);
    ASSERT_EQ(status, E_INVALID_PARAMETERS);
    queryOption.intention = UD_INTENTION_SYSTEM_SHARE;
    status = UdmfClient::GetInstance().DeleteData(queryOption, unifiedDataSet);
...
/**
* @tc.name: UpdateData006
* @tc.desc: test systemshare update data
* @tc.type: FUNC
*/
HWTEST_F(UdmfClientFileMangerTest, UpdateData006, TestSize.Level1)
{
    LOG_INFO(UDMF_TEST, "UpdateData006 begin.");
    CustomOption customOption = { .intention = Intention::UD_INTENTION_SYSTEM_SHARE };
    UnifiedData data;
    std::shared_ptr<UnifiedRecord> record = std::make_shared<PlainText>(UDType::PLAIN_TEXT, "plainTextContent");
    data.AddRecord(record);
    ...
    status = UdmfClient::GetInstance().DeleteData(query, unifiedDataSet);
    ASSERT_EQ(status, E_OK);
    LOG_INFO(UDMF_TEST, "UpdateData006 end.");
}

/**
* @tc.name: UpdateData007
* @tc.desc: test systemshare update data
* @tc.type: FUNC
*/
HWTEST_F(UdmfClientFileMangerTest, UpdateData007, TestSize.Level1)
{
    LOG_INFO(UDMF_TEST, "UpdateData007 begin.");
    CustomOption customOption = { .intention = Intention::UD_INTENTION_SYSTEM_SHARE };
    UnifiedData data;
    std::shared_ptr<UnifiedRecord> record = std::make_shared<PlainText>(UDType::PLAIN_TEXT, "plainTextContent");
    data.AddRecord(record);
    ...
    status = UdmfClient::GetInstance().DeleteData(query, unifiedDataSet);
    ASSERT_EQ(status, E_OK);
    LOG_INFO(UDMF_TEST, "UpdateData007 end.");
}

/**
* @tc.name: UpdateData008
* @tc.desc: test menu update data
* @tc.type: FUNC
*/
HWTEST_F(UdmfClientFileMangerTest, UpdateData008, TestSize.Level1)
{
    LOG_INFO(UDMF_TEST, "UpdateData008 begin.");
    CustomOption customOption = { .intention = Intention::UD_INTENTION_MENU };
    UnifiedData data;
    std::shared_ptr<UnifiedRecord> record = std::make_shared<PlainText>(UDType::PLAIN_TEXT, "plainTextContent");
    data.AddRecord(record);
    ...
    status = UdmfClient::GetInstance().DeleteData(query, unifiedDataSet);
    ASSERT_EQ(status, E_OK);
    LOG_INFO(UDMF_TEST, "UpdateData008 end.");
}

/**
* @tc.name: UpdateData011
* @tc.desc: test menu update data
* @tc.type: FUNC
*/
HWTEST_F(UdmfClientFileMangerTest, UpdateData011, TestSize.Level1)
{
    LOG_INFO(UDMF_TEST, "UpdateData011 begin.");
    CustomOption customOption = { .intention = Intention::UD_INTENTION_MENU };
    UnifiedData data;
    std::shared_ptr<UnifiedRecord> record = std::make_shared<PlainText>(UDType::PLAIN_TEXT, "plainTextContent");
    data.AddRecord(record);
    ...
    status = UdmfClient::GetInstance().DeleteData(query, unifiedDataSet);
    ASSERT_EQ(status, E_OK);
    LOG_INFO(UDMF_TEST, "UpdateData011 end.");
}

/**
* @tc.name: UpdateData012
* @tc.desc: test menu update data
* @tc.type: FUNC
*/
HWTEST_F(UdmfClientFileMangerTest, UpdateData012, TestSize.Level1)
{
    LOG_INFO(UDMF_TEST, "UpdateData012 begin.");
    CustomOption customOption = { .intention = Intention::UD_INTENTION_MENU };
    UnifiedData data;
    std::shared_ptr<UnifiedRecord> record = std::make_shared<PlainText>(UDType::PLAIN_TEXT, "plainTextContent");
    data.AddRecord(record);
    ...
    status = UdmfClient::GetInstance().DeleteData(query, unifiedDataSet);
    ASSERT_EQ(status, E_OK);
    LOG_INFO(UDMF_TEST, "UpdateData012 end.");
}
}
