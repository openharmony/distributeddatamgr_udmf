...
public:
    ...
    virtual int32_t SetDelayData(const std::string &, const UnifiedData &) = 0;
    virtual int32_t GetDelayData(const DataLoadInfo &, sptr<IRemoteObject>, std::shared_ptr<UnifiedData>) = 0;
public:
...
public:
    ...
    MOCK_METHOD(int32_t, SetDelayData, (const std::string &, const UnifiedData &));
    MOCK_METHOD(int32_t, GetDelayData, (const DataLoadInfo &, sptr<IRemoteObject>, std::shared_ptr<UnifiedData>));
};
} // namespace UDMF
} // namespace OHOS
