...
void PresetTypeDescriptors::InitDescriptors()
{
    typeDescriptors_ = {
        ...
        {"com.adobe.postscript-pfa-font",
         ...
         "REFERENCE_URL",
         ""},
        {"com.microsoft.portable-excutable",
         {"general.executable"},
         {".exe", ".dll"},
        ...
        {"com.allume.stuffit-archive",
         {"general.entity", "general.archive"},
         {".sit", ".sitx"},
        ...
        {"org.openxmlformats.wordprocessingml.document",
         ...
         {".docx", ".docm"},
         {"application/vnd.openxmlformats-office", "document.wordprocessingml.document"},
        ...
        {"org.openxmlformats.spreadsheetml.sheet",
         {"org.openxmlformats.openxml", "general.composite-object"},
         {".xlsx", ".xlsm"},
         {"application/vnd.openxmlformats-office", "document.spreadsheetml.sheet"},
        ...
        {"org.openxmlformats.presentationml.presentation",
         {"org.openxmlformats.openxml", "general.composite-object"},
         {".pptx", ".pptm"},
         {"application/vnd.openxmlformats-office", "document.presentationml.presentation"},
