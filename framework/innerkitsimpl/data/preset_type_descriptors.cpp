...
void PresetTypeDescriptors::InitDescriptors()
{
    typeDescriptors_ = {
        ...
        {"com.sursen.sep",
         ...
         {".sep"},
         {""},
         "Sursen Reader sep ebook format",
         REFERENCE_URL,
         ""},
        {"com.sursen.gd",
         {"general.ebook"},
        ...
        {"com.sursen.s72",
         ...
         {".s72"},
         {""},
         "Sursen Reader s72 ebook format",
         REFERENCE_URL,
         ""},
        {"com.sursen.s92",
         {"general.ebook"},
         {".s92"},
         {""},
         "Sursen Reader s92 ebook format",
         REFERENCE_URL,
         ""},
        {"com.sursen.s10",
         {"general.ebook"},
         {".s10"},
         {""},
         "Sursen Reader s10 ebook format",
         REFERENCE_URL,
         ""},
    };
}
