...
void PresetTypeDescriptors::InitDescriptors()
{
    typeDescriptors_ = {
        ...
        {"general.directory",
         ...
         REFERENCE_URL,
         "ohos_ic_normal_white_grid_folder"},
        {"general.folder",
         {"general.directory"},
         {},
         {},
        ...
        {"general.video",
         ...
         "Base type for video.",
         REFERENCE_URL,
         "ohos_ic_normal_white_grid_video"},
        {"general.avi",
         {"general.video"},
         {".avi", ".vfw"},
        ...
        {"general.flac",
         ...
         "FLAC audio.",
         REFERENCE_URL,
         "ohos_ic_normal_white_grid_flac"},
        {"general.alac",
         {"general.audio"},
         {".alac"},
         {"audio/alac"},
        ...
        {"general.archive",
         ...
         REFERENCE_URL,
         "ohos_ic_normal_white_grid_compress"},
        {"general.tar-archive",
         {"general.archive"},
         {".tar"},
        ...
        {"general.html",
         ...
         "HTML text.",
         REFERENCE_URL,
         "ohos_ic_normal_white_grid_html"},
        {"general.hyperlink",
         {"general.text"},
         {},
         {},
        ...
        {"general.calendar",
         ...
         REFERENCE_URL,
         "ohos_ic_normal_white_grid_calendar"},
        {"general.message",
         {"general.object"},
         {},
         {},
