 ...
 */
#ifndef UDMF_MESSAGE_PARCEL_MOCK_H
#define UDMF_MESSAGE_PARCEL_MOCK_H
...
namespace OHOS::UDMF {
class UdmfMessageParcel {
public:
    virtual ~UdmfMessageParcel() = default;
public:
...
public:
    static inline std::shared_ptr<UdmfMessageParcel> messageParcel = nullptr;
};

class MessageParcelMock : public UdmfMessageParcel {
public:
...
#endif // UDMF_MESSAGE_PARCEL_MOCK_H
