...
export class i extends ViewPU {
    ...
    CardDivider(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Divider.opacity(0.5);
            Divider.padding({
                left: this.formStyle.v2 * this.cardScale,
                right: this.formStyle.v2 * this.cardScale
            });
        }, Divider);
    }
    ...
    AppView(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: this.formStyle.u2 * this.cardScale });
            Row.padding({
                left: this.formStyle.v2 * this.cardScale,
                right: this.formStyle.v2 * this.cardScale,
                top: this.formStyle.z2 * this.cardScale,
                bottom: this.formStyle.w2 * this.cardScale,
            });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.appImage);
            Image.width(this.formStyle.s2 * this.cardScale);
            Image.height(this.formStyle.s2 * this.cardScale);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontSize(this.formStyle.o2 * this.cardScale);
            Text.fontColor(q1);
            Text.maxLines(1);
            Text.lineHeight(this.formStyle.q2 * this.cardScale);
    ...
    TitleText(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.maxLines(1);
            Text.textOverflow({ overflow: TextOverflow.Ellipsis });
            Text.height(this.formStyle.h2 * this.cardScale);
            Text.margin({ top: this.formStyle.i2 * this.cardScale });
    ...
    Card4x4(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.width('100%');
            Image.height(this.formStyle.f2 * this.cardScale);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.margin({ bottom: this.formStyle.n2 * this.cardScale });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.height(this.formStyle.l2 * this.cardScale);
            Text.margin({ top: this.formStyle.m2 * this.cardScale });
    ...
    DescriptionView(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.lineHeight((this.lineCount === 1 ?
                (this.formStyle.c3 ? this.formStyle.c3 :
                this.formStyle.l2) : this.formStyle.l2) * this.cardScale);
            ...
            if (this.contentFormData?.title === '') {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Row.layoutWeight(1);
                        Row.margin({ bottom: this.formStyle.n2 * this.cardScale });
                        Row.alignItems(VerticalAlign.Top);
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create({ space: this.formStyle.m2 * this.cardScale });
                            ...
                            this.ifElseBranchUpdateFunction(0, () => {
                                if (!If.canRetake('cardThumbImage')) {
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Image.width(this.formStyle.e2 * this.cardScale);
                                        Image.height(this.formStyle.f2 * this.cardScale);
                                        Image.objectFit(this.thumbImage ? ImageFit.Cover : ImageFit.Contain);
                                        Image.borderRadius(4);
                                        Image.draggable(false);
                                        Image.margin({
                                            right: this.isMirrorLanguageType ? (this.formStyle.a3 * this.cardScale) : 0,
                                            left: this.isMirrorLanguageType ? 0 : (this.formStyle.a3 * this.cardScale),
                                            top: this.formStyle.i2 * this.cardScale
                                        });
                                        Image.id('cardThumbImage');
                                    }, Image);
                                }
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.contentFormData?.title === '') {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.margin({ top: this.formStyle.m2 * this.cardScale });
                        Row.layoutWeight(1);
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.borderRadius(this.formStyle.t2 * this.cardScale);
            Column.clip(true);
    ...
    getDescriptionFontSize() {
        return this.lineCount === 1 ? (this.formStyle.b3 ? this.formStyle.b3 :
