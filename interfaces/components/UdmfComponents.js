...
const m = '82,73,70,70,60,3,0,0,87,69,66,80,86,80,56,32,48,3,0,0,144,67,0,157,1,42,36,2,76,1,62,145,72,161,76,37,164,163,34,3' +
...
export class ContentFormCard extends ViewPU {
    ...
    AppView(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.borderRadius({ "id": -1, "type": 10002, params: ['sys.float.corner_radius_level1'], "bundleName": "__harDefaultBundleName__", "moduleName": "__harDefaultModuleName__" });
            Image.draggable(false);
    ...
    Card4x4(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.maxLines(1);
            Text.textOverflow({ overflow: TextOverflow.Ellipsis });
            Text.constraintSize({ minWidth: this.getTextSize(TextType.DESCRIPTION, this.contentFormData?.description) });
                            ...
                            this.ifElseBranchUpdateFunction(0, () => {
                                if (!If.canRetake('cardThumbImage')) {
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Image.create(this.thumbImage);
                                        Image.objectFit(ImageFit.Cover);
                                        Image.borderRadius({ "id": -1, "type": 10002, params: ['sys.float.corner_radius_level2'], "bundleName": "__harDefaultBundleName__", "moduleName": "__harDefaultModuleName__" });
                                        Image.width(this.formStyle.d2 * this.cardScale);
                                        Image.height(this.formStyle.e2 * this.cardScale);
                                        Image.draggable(false);
                                        Image.margin({
