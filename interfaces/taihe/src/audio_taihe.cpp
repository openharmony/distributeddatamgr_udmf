 ...
 */
#define LOG_TAG "UDMF_AUDIO_TAIHE"
...
::taihe::array<::taihe::string> AudioTaihe::GetTypes()
{
...
void AudioTaihe::AddEntry(::taihe::string_view type, ::taiheChannel::ValueType value)
{
    if (type.empty()) {
...
::taiheChannel::ValueType AudioTaihe::GetEntry(::taihe::string_view type)
{
    if (!this->value_) {
        LOG_ERROR(UDMF_ANI, "Inner value is null.");
        taihe::set_business_error(PARAMETERSERROR, "invalid object!");
...
::taihe::map<::taihe::string, ::taiheChannel::ValueType> AudioTaihe::GetEntries()
{
