 ...
 */
#define LOG_TAG "UDMF_HYPERLINK_TAIHE"
...
::taihe::array<::taihe::string> HyperlinkTaihe::GetTypes()
{
...
void HyperlinkTaihe::AddEntry(::taihe::string_view type, ::taiheChannel::ValueType value)
{
    if (type.empty()) {
...
::taiheChannel::ValueType HyperlinkTaihe::GetEntry(::taihe::string_view type)
{
    if (!this->value_) {
        LOG_ERROR(UDMF_ANI, "Inner value is null.");
        taihe::set_business_error(PARAMETERSERROR, "invalid object!");
...
::taihe::map<::taihe::string, ::taiheChannel::ValueType> HyperlinkTaihe::GetEntries()
{
