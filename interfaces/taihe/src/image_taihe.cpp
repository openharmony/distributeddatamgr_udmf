 ...
 */
#define LOG_TAG "UDMF_IMAGE_TAIHE"
...
::taihe::array<::taihe::string> ImageTaihe::GetTypes()
{
...
void ImageTaihe::AddEntry(::taihe::string_view type, ::taiheChannel::ValueType value)
{
    if (type.empty()) {
...
::taiheChannel::ValueType ImageTaihe::GetEntry(::taihe::string_view type)
{
    if (!this->value_) {
        LOG_ERROR(UDMF_ANI, "Inner value is null.");
        taihe::set_business_error(PARAMETERSERROR, "invalid object!");
...
::taihe::map<::taihe::string, ::taiheChannel::ValueType> ImageTaihe::GetEntries()
{
...
void ImageTaihe::SetUriAuthorizationPolicies(
