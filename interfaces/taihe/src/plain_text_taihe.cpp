 ...
 */
#define LOG_TAG "UDMF_PLAIN_TEXT_TAIHE"
...
::taihe::array<::taihe::string> PlainTextTaihe::GetTypes()
{
...
void PlainTextTaihe::AddEntry(::taihe::string_view type, ::taiheChannel::ValueType value)
{
    if (type.empty()) {
...
::taiheChannel::ValueType PlainTextTaihe::GetEntry(::taihe::string_view type)
{
    if (!this->value_) {
        LOG_ERROR(UDMF_ANI, "Inner value is null.");
        taihe::set_business_error(PARAMETERSERROR, "invalid object!");
...
::taihe::map<::taihe::string, ::taiheChannel::ValueType> PlainTextTaihe::GetEntries()
{
