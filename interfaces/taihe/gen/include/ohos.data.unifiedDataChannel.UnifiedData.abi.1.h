...
struct ohos_data_unifiedDataChannel_UnifiedData_ftable {
    void (*AddRecord)(struct ohos_data_unifiedDataChannel_UnifiedData_t tobj, struct ohos_data_unifiedDataChannel_UnifiedRecord_t unifiedRecord);
    struct TArray (*GetRecords)(struct ohos_data_unifiedDataChannel_UnifiedData_t tobj);
