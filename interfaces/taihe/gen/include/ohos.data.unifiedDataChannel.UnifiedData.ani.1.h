...
inline ::ohos::data::unifiedDataChannel::UnifiedData ohos_data_unifiedDataChannel_UnifiedData_fromANI(ani_env* env, ani_object ani_obj) {
    struct cpp_impl_t {
        ...
        void AddRecord(::ohos::data::unifiedDataChannel::weak::UnifiedRecord cpp_arg_unifiedRecord) {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_object ani_arg_unifiedRecord = ohos_data_unifiedDataChannel_UnifiedRecord_intoANI(env, cpp_arg_unifiedRecord);
        ...
        ::taihe::array<::ohos::data::unifiedDataChannel::UnifiedRecord> GetRecords() {
            ...
            ::ohos::data::unifiedDataChannel::UnifiedRecord* cpp_result_buffer = reinterpret_cast<::ohos::data::unifiedDataChannel::UnifiedRecord*>(malloc(cpp_result_size * sizeof(::ohos::data::unifiedDataChannel::UnifiedRecord)));
            for (size_t cpp_result_buffer_i = 0; cpp_result_buffer_i < cpp_result_size; cpp_result_buffer_i++) {
                ani_object cpp_result_buffer_ani_item;
                env->Array_Get_Ref(ani_result, cpp_result_buffer_i, reinterpret_cast<ani_ref*>(&cpp_result_buffer_ani_item));
                ::ohos::data::unifiedDataChannel::UnifiedRecord cpp_result_buffer_cpp_item = ohos_data_unifiedDataChannel_UnifiedRecord_fromANI(env, cpp_result_buffer_ani_item);
                new (&cpp_result_buffer[cpp_result_buffer_i]) ::ohos::data::unifiedDataChannel::UnifiedRecord(std::move(cpp_result_buffer_cpp_item));
            }
            ::taihe::array<::ohos::data::unifiedDataChannel::UnifiedRecord> cpp_result(cpp_result_buffer, cpp_result_size);
            return cpp_result;
        }
        int64_t GetInner() {
            ::taihe::env_guard guard;
