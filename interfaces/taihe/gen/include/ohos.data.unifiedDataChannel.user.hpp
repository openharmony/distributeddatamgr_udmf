...
namespace ohos::data::unifiedDataChannel {
inline ::ohos::data::unifiedDataChannel::UnifiedData CreateUnifiedDataWithParams(::ohos::data::unifiedDataChannel::weak::UnifiedRecord unifiedRecord) {
    return ::taihe::from_abi<::ohos::data::unifiedDataChannel::UnifiedData>(ohos_data_unifiedDataChannel_CreateUnifiedDataWithParams_f(::taihe::into_abi<::ohos::data::unifiedDataChannel::weak::UnifiedRecord>(unifiedRecord)));
}
}
namespace ohos::data::unifiedDataChannel {
