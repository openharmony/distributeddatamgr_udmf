#pragma once
#include "ohos.data.unifiedDataChannel.VideoInner.ani.0.h"
#include "ohos.data.unifiedDataChannel.VideoInner.proj.2.hpp"
#include "ohos.data.unifiedDataChannel.ValueType.ani.1.h"
inline ::ohos::data::unifiedDataChannel::VideoInner ohos_data_unifiedDataChannel_VideoInner_fromANI(ani_env* env, ani_object ani_obj) {
    struct cpp_impl_t {
        ani_ref ref;
        ...
        ::taihe::string GetType() {
            ...
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "getType", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
        ...
        ::ohos::data::unifiedDataChannel::ValueType GetValue() {
            ...
            ani_env *env = guard.get_env();
            ani_ref ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "getValue", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
        ...
        ::taihe::string GetUri() {
            ...
            ani_env *env = guard.get_env();
            ani_string ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "<get>uri", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
            ani_size cpp_result_len;
            env->String_GetUTF8Size(ani_result, &cpp_result_len);
            TString cpp_result_tstr;
            char* cpp_result_buf = tstr_initialize(&cpp_result_tstr, cpp_result_len + 1);
        ...
        void SetUri(::taihe::string_view cpp_arg_uri) {
            ...
            env->Object_CallMethod_Void(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "<set>uri", nullptr), ani_arg_uri);
        }
        ::taihe::optional<::taihe::map<::taihe::string, ::taihe::string>> GetDetails() {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_ref ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "<get>details", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
        ...
        void SetDetails(::taihe::map_view<::taihe::string, ::taihe::string> cpp_arg_details) {
            ...
            env->Object_CallMethod_Void(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "<set>details", nullptr), ani_arg_details);
        }
        ::taihe::string GetVideoUri() {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_string ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "<get>videoUri", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
            ani_size cpp_result_len;
            env->String_GetUTF8Size(ani_result, &cpp_result_len);
            TString cpp_result_tstr;
            char* cpp_result_buf = tstr_initialize(&cpp_result_tstr, cpp_result_len + 1);
        ...
        void SetVideoUri(::taihe::string_view cpp_arg_videoUri) {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_string ani_arg_videoUri;
            env->String_NewUTF8(cpp_arg_videoUri.c_str(), cpp_arg_videoUri.size(), &ani_arg_videoUri);
            env->Object_CallMethod_Void(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "<set>videoUri", nullptr), ani_arg_videoUri);
        }
        int64_t GetInner() {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_long ani_result;
            env->Object_CallMethod_Long(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "getInner", nullptr), reinterpret_cast<ani_long*>(&ani_result));
            int64_t cpp_result = (int64_t)ani_result;
            return cpp_result;
        }
    };
    return ::taihe::make_holder<cpp_impl_t, ::ohos::data::unifiedDataChannel::VideoInner>(env, ani_obj);
}
inline ani_object ohos_data_unifiedDataChannel_VideoInner_intoANI(ani_env* env, ::ohos::data::unifiedDataChannel::VideoInner cpp_obj) {
    ...
    ani_object ani_obj;
    env->Object_New(TH_ANI_FIND_CLASS(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;"), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/VideoInner;", "<ctor>", "JJ:V"), &ani_obj, ani_vtbl_ptr, ani_data_ptr);
    return ani_obj;
}
