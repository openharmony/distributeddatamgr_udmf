#pragma once
#include "ohos.data.unifiedDataChannel.UnifiedDataInner.ani.0.h"
#include "ohos.data.unifiedDataChannel.UnifiedDataInner.proj.2.hpp"
#include "ohos.data.unifiedDataChannel.AllRecords.ani.1.h"
inline ::ohos::data::unifiedDataChannel::UnifiedDataInner ohos_data_unifiedDataChannel_UnifiedDataInner_fromANI(ani_env* env, ani_object ani_obj) {
    struct cpp_impl_t {
        ani_ref ref;
        ...
        void AddRecord(::ohos::data::unifiedDataChannel::AllRecords const& cpp_arg_unifiedRecord) {
            ...
            env->Object_CallMethod_Void(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedDataInner;", "addRecord", nullptr), ani_arg_unifiedRecord);
        }
        ::taihe::array<::ohos::data::unifiedDataChannel::AllRecords> GetRecords() {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_array_ref ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedDataInner;", "getRecords", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
        ...
        int64_t GetInner() {
            ...
            ani_env *env = guard.get_env();
            ani_long ani_result;
            env->Object_CallMethod_Long(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedDataInner;", "getInner", nullptr), reinterpret_cast<ani_long*>(&ani_result));
            int64_t cpp_result = (int64_t)ani_result;
            return cpp_result;
        }
    };
    return ::taihe::make_holder<cpp_impl_t, ::ohos::data::unifiedDataChannel::UnifiedDataInner>(env, ani_obj);
}
inline ani_object ohos_data_unifiedDataChannel_UnifiedDataInner_intoANI(ani_env* env, ::ohos::data::unifiedDataChannel::UnifiedDataInner cpp_obj) {
    ...
    ani_object ani_obj;
    env->Object_New(TH_ANI_FIND_CLASS(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedDataInner;"), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedDataInner;", "<ctor>", "JJ:V"), &ani_obj, ani_vtbl_ptr, ani_data_ptr);
    return ani_obj;
}
