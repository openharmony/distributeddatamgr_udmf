...
TH_INLINE void ohos_data_unifiedDataChannel_UnifiedData_AddRecord_f(struct ohos_data_unifiedDataChannel_UnifiedData_t tobj, struct ohos_data_unifiedDataChannel_AllRecords_t const* unifiedRecord) {
