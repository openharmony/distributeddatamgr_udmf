...
inline void UnifiedData::virtual_type::AddRecord(::ohos::data::unifiedDataChannel::AllRecords const& unifiedRecord) const& {
    return ohos_data_unifiedDataChannel_UnifiedData_AddRecord_f(*reinterpret_cast<ohos_data_unifiedDataChannel_UnifiedData_t const*>(this), ::taihe::into_abi<::ohos::data::unifiedDataChannel::AllRecords const&>(unifiedRecord));
}
}
namespace ohos::data::unifiedDataChannel::weak {
inline ::taihe::array<::ohos::data::unifiedDataChannel::AllRecords> UnifiedData::virtual_type::GetRecords() const& {
    return ::taihe::from_abi<::taihe::array<::ohos::data::unifiedDataChannel::AllRecords>>(ohos_data_unifiedDataChannel_UnifiedData_GetRecords_f(*reinterpret_cast<ohos_data_unifiedDataChannel_UnifiedData_t const*>(this)));
}
}
namespace ohos::data::unifiedDataChannel::weak {
...
void UnifiedData::methods_impl<Impl>::AddRecord(struct ohos_data_unifiedDataChannel_UnifiedData_t tobj, struct ohos_data_unifiedDataChannel_AllRecords_t const* unifiedRecord) {
