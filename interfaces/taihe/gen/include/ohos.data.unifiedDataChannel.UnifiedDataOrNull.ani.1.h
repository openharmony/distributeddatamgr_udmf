...
inline ::ohos::data::unifiedDataChannel::UnifiedDataOrNull ohos_data_unifiedDataChannel_UnifiedDataOrNull_fromANI(ani_env* env, ani_ref ani_value) {
    ...
    env->Object_InstanceOf(static_cast<ani_object>(ani_value), TH_ANI_FIND_CLASS(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedData;"), &ani_is_unifiedData);
    if (ani_is_unifiedData) {
        ::ohos::data::unifiedDataChannel::UnifiedData cpp_field_unifiedData = ohos_data_unifiedDataChannel_UnifiedData_fromANI(env, static_cast<ani_object>(ani_value));
...
inline ani_ref ohos_data_unifiedDataChannel_UnifiedDataOrNull_intoANI(ani_env* env, ::ohos::data::unifiedDataChannel::UnifiedDataOrNull const& cpp_value) {
    ...
    case ::ohos::data::unifiedDataChannel::UnifiedDataOrNull::tag_t::unifiedData: {
        ani_object ani_field_unifiedData = ohos_data_unifiedDataChannel_UnifiedData_intoANI(env, cpp_value.get_unifiedData_ref());
