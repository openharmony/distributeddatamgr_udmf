...
struct UnifiedData {
    ...
    struct virtual_type {
        void AddRecord(::ohos::data::unifiedDataChannel::weak::UnifiedRecord unifiedRecord) const&;
        ::taihe::array<::ohos::data::unifiedDataChannel::UnifiedRecord> GetRecords() const&;
        int64_t GetInner() const&;
    };
    template<typename Impl>
    struct methods_impl {
        static void AddRecord(struct ohos_data_unifiedDataChannel_UnifiedData_t tobj, struct ohos_data_unifiedDataChannel_UnifiedRecord_t unifiedRecord);
