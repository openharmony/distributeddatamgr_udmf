...
struct UnifiedData {
    ...
    struct virtual_type {
        void AddRecord1(::ohos::data::unifiedDataChannel::AllRecords const& unifiedRecord) const&;
        ::taihe::array<::ohos::data::unifiedDataChannel::AllRecords> GetRecords1() const&;
        int64_t GetInner() const&;
    };
    template<typename Impl>
    struct methods_impl {
        static void AddRecord1(struct ohos_data_unifiedDataChannel_UnifiedData_t tobj, struct ohos_data_unifiedDataChannel_AllRecords_t const* unifiedRecord);
        static struct TArray GetRecords1(struct ohos_data_unifiedDataChannel_UnifiedData_t tobj);
    ...
    static constexpr ohos_data_unifiedDataChannel_UnifiedData_ftable ftbl_impl = {
        .AddRecord1 = &methods_impl<Impl>::AddRecord1,
        .GetRecords1 = &methods_impl<Impl>::GetRecords1,
