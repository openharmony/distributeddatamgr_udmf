...
TH_EXPORT struct ohos_data_unifiedDataChannel_UnifiedData_t ohos_data_unifiedDataChannel_CreateUnifiedDataWithParams_f(struct ohos_data_unifiedDataChannel_AllRecords_t const* unifiedRecord);
