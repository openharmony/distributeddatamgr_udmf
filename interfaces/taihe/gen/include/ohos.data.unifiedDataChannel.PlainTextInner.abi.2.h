...
TH_INLINE void ohos_data_unifiedDataChannel_PlainTextInner_SetAbstract1_f(struct ohos_data_unifiedDataChannel_PlainTextInner_t tobj, struct TString abstract1) {
    return tobj.vtbl_ptr->ftbl_ptr_0->SetAbstract1(tobj, abstract1);
}
TH_INLINE struct TString ohos_data_unifiedDataChannel_PlainTextInner_GetAbstract1_f(struct ohos_data_unifiedDataChannel_PlainTextInner_t tobj) {
