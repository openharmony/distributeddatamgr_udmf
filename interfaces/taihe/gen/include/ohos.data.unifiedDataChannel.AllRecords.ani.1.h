...
inline ::ohos::data::unifiedDataChannel::AllRecords ohos_data_unifiedDataChannel_AllRecords_fromANI(ani_env* env, ani_ref ani_value) {
    ...
    env->Object_InstanceOf(static_cast<ani_object>(ani_value), TH_ANI_FIND_CLASS(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/File;"), &ani_is_file);
    if (ani_is_file) {
        ::ohos::data::unifiedDataChannel::File cpp_field_file = ohos_data_unifiedDataChannel_File_fromANI(env, static_cast<ani_object>(ani_value));
    ...
    env->Object_InstanceOf(static_cast<ani_object>(ani_value), TH_ANI_FIND_CLASS(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedRecord;"), &ani_is_unifiedRecord);
    if (ani_is_unifiedRecord) {
        ::ohos::data::unifiedDataChannel::UnifiedRecord cpp_field_unifiedRecord = ohos_data_unifiedDataChannel_UnifiedRecord_fromANI(env, static_cast<ani_object>(ani_value));
...
inline ani_ref ohos_data_unifiedDataChannel_AllRecords_intoANI(ani_env* env, ::ohos::data::unifiedDataChannel::AllRecords const& cpp_value) {
    ...
    case ::ohos::data::unifiedDataChannel::AllRecords::tag_t::file: {
        ani_object ani_field_file = ohos_data_unifiedDataChannel_File_intoANI(env, cpp_value.get_file_ref());
        ani_value = ani_field_file;
        break;
    }
    case ::ohos::data::unifiedDataChannel::AllRecords::tag_t::unifiedRecord: {
        ani_object ani_field_unifiedRecord = ohos_data_unifiedDataChannel_UnifiedRecord_intoANI(env, cpp_value.get_unifiedRecord_ref());
