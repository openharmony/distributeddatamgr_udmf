#pragma once
#include "ohos.data.unifiedDataChannel.Folder.ani.0.h"
#include "ohos.data.unifiedDataChannel.Folder.proj.2.hpp"
#include "ohos.data.unifiedDataChannel.ValueType.ani.1.h"
inline ::ohos::data::unifiedDataChannel::Folder ohos_data_unifiedDataChannel_Folder_fromANI(ani_env* env, ani_object ani_obj) {
    struct cpp_impl_t {
        ani_ref ref;
        ...
        ::taihe::string GetType() {
            ...
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "getType", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
        ...
        ::ohos::data::unifiedDataChannel::ValueType GetValue() {
            ...
            ani_env *env = guard.get_env();
            ani_ref ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "getValue", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
        ...
        ::taihe::string GetUri() {
            ...
            ani_env *env = guard.get_env();
            ani_string ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "<get>uri", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
            ani_size cpp_result_len;
            env->String_GetUTF8Size(ani_result, &cpp_result_len);
            TString cpp_result_tstr;
            char* cpp_result_buf = tstr_initialize(&cpp_result_tstr, cpp_result_len + 1);
        ...
        void SetUri(::taihe::string_view cpp_arg_uri) {
            ...
            env->Object_CallMethod_Void(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "<set>uri", nullptr), ani_arg_uri);
        }
        ::taihe::optional<::taihe::map<::taihe::string, ::taihe::string>> GetDetails() {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_ref ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "<get>details", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
        ...
        void SetDetails(::taihe::map_view<::taihe::string, ::taihe::string> cpp_arg_details) {
            ...
            env->Object_CallMethod_Void(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "<set>details", nullptr), ani_arg_details);
        }
        ::taihe::string GetFolderUri() {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_string ani_result;
            env->Object_CallMethod_Ref(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "<get>folderUri", nullptr), reinterpret_cast<ani_ref*>(&ani_result));
            ani_size cpp_result_len;
            env->String_GetUTF8Size(ani_result, &cpp_result_len);
            TString cpp_result_tstr;
            char* cpp_result_buf = tstr_initialize(&cpp_result_tstr, cpp_result_len + 1);
        ...
        void SetFolderUri(::taihe::string_view cpp_arg_folderUri) {
            ...
            env->Object_CallMethod_Void(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "<set>folderUri", nullptr), ani_arg_folderUri);
        }
        int64_t GetInner() {
            ::taihe::env_guard guard;
            ani_env *env = guard.get_env();
            ani_long ani_result;
            env->Object_CallMethod_Long(static_cast<ani_object>(this->ref), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "getInner", nullptr), reinterpret_cast<ani_long*>(&ani_result));
            int64_t cpp_result = (int64_t)ani_result;
            return cpp_result;
        }
    };
    return ::taihe::make_holder<cpp_impl_t, ::ohos::data::unifiedDataChannel::Folder>(env, ani_obj);
}
inline ani_object ohos_data_unifiedDataChannel_Folder_intoANI(ani_env* env, ::ohos::data::unifiedDataChannel::Folder cpp_obj) {
    ...
    ani_object ani_obj;
    env->Object_New(TH_ANI_FIND_CLASS(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;"), TH_ANI_FIND_CLASS_METHOD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/Folder;", "<ctor>", "JJ:V"), &ani_obj, ani_vtbl_ptr, ani_data_ptr);
    return ani_obj;
}
