...
namespace ohos::data::unifiedDataChannel::weak {
inline void PlainTextInner::virtual_type::SetAbstract1(::taihe::string_view abstract1) const& {
    return ohos_data_unifiedDataChannel_PlainTextInner_SetAbstract1_f(*reinterpret_cast<ohos_data_unifiedDataChannel_PlainTextInner_t const*>(this), ::taihe::into_abi<::taihe::string_view>(abstract1));
}
}
namespace ohos::data::unifiedDataChannel::weak {
inline ::taihe::string PlainTextInner::virtual_type::GetAbstract1() const& {
    return ::taihe::from_abi<::taihe::string>(ohos_data_unifiedDataChannel_PlainTextInner_GetAbstract1_f(*reinterpret_cast<ohos_data_unifiedDataChannel_PlainTextInner_t const*>(this)));
}
}
namespace ohos::data::unifiedDataChannel::weak {
...
namespace ohos::data::unifiedDataChannel::weak {
template<typename Impl>
void PlainTextInner::methods_impl<Impl>::SetAbstract1(struct ohos_data_unifiedDataChannel_PlainTextInner_t tobj, struct TString abstract1) {
    return ::taihe::cast_data_ptr<Impl>(tobj.data_ptr)->SetAbstract1(::taihe::from_abi<::taihe::string_view>(abstract1));
}
}
namespace ohos::data::unifiedDataChannel::weak {
template<typename Impl>
struct TString PlainTextInner::methods_impl<Impl>::GetAbstract1(struct ohos_data_unifiedDataChannel_PlainTextInner_t tobj) {
