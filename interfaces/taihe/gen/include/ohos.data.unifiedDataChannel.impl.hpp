...
#define TH_EXPORT_CPP_API_CreateUnifiedDataWithParams(CPP_FUNC_IMPL) \
    struct ohos_data_unifiedDataChannel_UnifiedData_t ohos_data_unifiedDataChannel_CreateUnifiedDataWithParams_f(struct ohos_data_unifiedDataChannel_UnifiedRecord_t unifiedRecord) { \
        return ::taihe::into_abi<::ohos::data::unifiedDataChannel::UnifiedData>(CPP_FUNC_IMPL(::taihe::from_abi<::ohos::data::unifiedDataChannel::weak::UnifiedRecord>(unifiedRecord))); \
    }
