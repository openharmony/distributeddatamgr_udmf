...
static void ohos_data_unifiedDataChannel_UnifiedData_AddRecord1_ANIFunc([[maybe_unused]] ani_env *env, [[maybe_unused]] ani_object object, ani_ref ani_arg_unifiedRecord) {
    ...
    ::ohos::data::unifiedDataChannel::AllRecords cpp_arg_unifiedRecord = ohos_data_unifiedDataChannel_AllRecords_fromANI(env, ani_arg_unifiedRecord);
    ::ohos::data::unifiedDataChannel::weak::UnifiedData(cpp_iface)->AddRecord1(cpp_arg_unifiedRecord);
}
static ani_array_ref ohos_data_unifiedDataChannel_UnifiedData_GetRecords1_ANIFunc([[maybe_unused]] ani_env *env, [[maybe_unused]] ani_object object) {
    ani_long ani_data_ptr;
    env->Object_GetField_Long(object, TH_ANI_FIND_CLASS_FIELD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedData;", "_data_ptr"), reinterpret_cast<ani_long*>(&ani_data_ptr));
    ani_long ani_vtbl_ptr;
    env->Object_GetField_Long(object, TH_ANI_FIND_CLASS_FIELD(env, "L@ohos/data/unifiedDataChannel/unifiedDataChannel/UnifiedData;", "_vtbl_ptr"), reinterpret_cast<ani_long*>(&ani_vtbl_ptr));
    ...
    ohos_data_unifiedDataChannel_UnifiedData_vtable* cpp_vtbl_ptr = reinterpret_cast<ohos_data_unifiedDataChannel_UnifiedData_vtable*>(ani_vtbl_ptr);
    ::ohos::data::unifiedDataChannel::weak::UnifiedData cpp_iface = ::ohos::data::unifiedDataChannel::weak::UnifiedData({cpp_vtbl_ptr, cpp_data_ptr});
    ::taihe::array<::ohos::data::unifiedDataChannel::AllRecords> cpp_result = ::ohos::data::unifiedDataChannel::weak::UnifiedData(cpp_iface)->GetRecords1();
    if (::taihe::has_error()) { return ani_array_ref{}; }
    size_t ani_result_size = cpp_result.size();
    ani_array_ref ani_result;
    ani_class ani_result_cls;
...
ani_status ANIRegister(ani_env *env) {
    ...
    }
    {
        ...
        ani_native_function methods[] = {
            {"AddRecord1_inner", nullptr, reinterpret_cast<void*>(ohos_data_unifiedDataChannel_UnifiedData_AddRecord1_ANIFunc)},
            {"GetRecords1_inner", nullptr, reinterpret_cast<void*>(ohos_data_unifiedDataChannel_UnifiedData_GetRecords1_ANIFunc)},
