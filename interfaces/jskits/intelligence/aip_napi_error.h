...
enum NativeErrCode : int32_t {
    ...
    NATIVE_RAGSESSION_CONSTRUCT_FAULT,
    NATIVE_RAGSESSION_STREAMRUN_FAULT,
...
enum TsErrCode : int32_t {
    ...
    RAG_E_LLM_REQUEST_FAILED = 32800003,
    RAG_E_LLM_BUSY = 32800004,
    RAG_E_LLM_OUTPUT_INVALID = 32800005,
    RAG_E_RAG_ALREADY_EXISTS = 32800006,
    RAG_E_RAG_BUSY = 32800007,
    RAG_E_RAG_ALREADY_CLOSED = 32800008,
    RAG_E_RAG_USER_CANCEL = 32800009,
    RAG_E_RAG_TIMEOUT = 32800010,
    RAG_E_RAG_PARAM_ERROR = 32800011,
};
