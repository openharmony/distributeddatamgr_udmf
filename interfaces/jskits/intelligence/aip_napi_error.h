...
enum NativeErrCode : int32_t {
    ...
    NATIVE_SUMMARY_E_INVALID_PARAMETERS = 28114959,
    NATIVE_SUMMARY_E_INVALID_RESULT = 28114960,
    NATIVE_SUMMARY_E_INVALID_OUTPUT = 28114961,

    NATIVE_RAG_E_RETRIEVE_ERROR = 28114962,
    NATIVE_RAG_E_LLM_ERROR = 28114963,
    NATIVE_RAG_E_EMBEDDING_ERROR = 28114964,
    NATIVE_RAG_E_PROMPT_ERROR = 28114965,
    NATIVE_RAG_E_QUERY_LENGTH_EXCEED = 28114966,
    NATIVE_RAG_E_INSTANCE_EXIST = 28114967,
    NATIVE_RAG_E_INSTANCE_NOT_EXIST = 28114968,
    NATIVE_RAG_E_STREAM_BUSY = 28114969,
    NATIVE_RAG_E_CONFIG_ERROR = 28114970,
    NATIVE_RAG_E_INVALID_INPUT = 28114971,
    NATIVE_RAG_E_LLM_OCCUPIED = 28114972,
    NATIVE_RAG_E_LLM_TIMEOUT = 28114973,
    NATIVE_RAG_E_LLM_STREAM_TIMEOUT = 28114974,
    NATIVE_RAG_E_LLM_OUTPUT_INVALID = 28114975,
    NATIVE_RAG_E_RETRIEVER_TIMEOUT = 28114976,
    NATIVE_LLM_E_PARSER_JSON_PARSE = 28114977,
    NATIVE_LLM_E_PARSER_JSON_MEMBER = 28114978,
    NATIVE_LLM_E_REQUEST_MALLOC = 28114979,
    NATIVE_PROMPT_E_PLACEHOLDER_JSON_PARSE = 28114980,
    NATIVE_PROMPT_E_CHAT_TEMP_JSON_TYPE = 28114981,
    NATIVE_PROMPT_E_CHAT_TEMP_EMPTY_MSG = 28114982,
    NATIVE_PROMPT_E_CHAT_TEMP_UPDATE_SYS = 28114983,
};
...
enum TsErrCode : int32_t {
    ...
    RAG_E_RAG_COMMON_ERROR = 31302000,
    RAG_E_LLM_TIMEOUT = 31302001,
    RAG_E_LLM_LOAD_FAILED = 31302002,
    RAG_E_LLM_BUSY = 31302003,
    RAG_E_LLM_OUTPUT_INVALID = 31302004,
    RAG_E_RAG_ALREADY_EXISTS = 31302005,
    RAG_E_RAG_BUSY = 31302006,
    RAG_E_RAG_ALREADY_CLOSED = 31302007,
    RAG_E_RAG_USER_CANCEL = 31302008,
    RAG_E_RAG_TIMEOUT = 31302009,
};
