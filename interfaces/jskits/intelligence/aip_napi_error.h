...
enum NativeErrCode : int32_t {
    ...
    GRAPH_RETRIEVAL_E_GDB_NOT_INIT,
    GRAPH_RETRIEVAL_E_RDB_NOT_INIT,
    GRAPH_RETRIEVAL_E_MEMORY_ALLOC_FAILURE,
    GRAPH_RETRIEVAL_E_ALGORITHM_NOT_INIT,
    GRAPH_RETRIEVAL_E_RDB_QUERY_FAILURE,
    GRAPH_RETRIEVAL_E_GDB_QUERY_FAILURE,
    DATABASE_E_GDB_INVALID,
};
