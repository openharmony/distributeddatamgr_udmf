...
enum NativeErrCode : int32_t {
    ...
    NATIVE_SUMMARY_E_INVALID_PARAMETERS,
    NATIVE_SUMMARY_E_INVALID_RESULT,
    NATIVE_SUMMARY_E_INVALID_OUTPUT,
    
    NATIVE_RAG_E_CONFIG_ERROR,
    NATIVE_RAG_E_INSTANCE_EXIST,
    NATIVE_RAG_E_INVALID_INPUT,
    NATIVE_RAG_E_QUERY_LENGTH_EXCEED,
    NATIVE_RAG_E_STREAM_BUSY,
    NATIVE_RAG_E_INSTANCE_NOT_EXIST,
    NATIVE_RAG_E_PROMPT_ERROR,
    NATIVE_RAG_E_LLM_ERROR,
    NATIVE_RAG_E_LLM_OCCUPIED,
    NATIVE_RAG_E_LLM_TIMEOUT,
    NATIVE_RAG_E_LLM_OUTPUT_INVALID,
    NATIVE_RAG_E_RETRIEVER_TIMEOUT,
    
    NATIVE_LLM_E_PARSER_JSON_PARSE,
    NATIVE_LLM_E_PARSER_JSON_MEMBER,
    NATIVE_LLM_E_REQUEST_MALLOC,
    NATIVE_PROMPT_E_PLACEHOLDER_JSON_PARSE,
    NATIVE_PROMPT_E_CHAT_TEMP_JSON_TYPE,
    NATIVE_PROMPT_E_CHAT_TEMP_EMPTY_MSG,
    NATIVE_PROMPT_E_CHAT_TEMP_UPDATE_SYS,
};
