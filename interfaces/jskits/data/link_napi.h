...
#ifndef UDMF_LINK_NAPI_H
#define UDMF_LINK_NAPI_H
...
private:
    ...
    static LinkNapi *GetLink(napi_env env, napi_callback_info info, std::shared_ptr<ContextBase> ctxt);
