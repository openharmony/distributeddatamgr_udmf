...
private:
    ...
    static AudioNapi *GetAudio(napi_env env, napi_callback_info info, std::shared_ptr<ContextBase> ctxt);
    static napi_value GetAudioUri(napi_env env, napi_callback_info info);
    static napi_value SetAudioUri(napi_env env, napi_callback_info info);
};
} // namespace UDMF
} // namespace OHOS
