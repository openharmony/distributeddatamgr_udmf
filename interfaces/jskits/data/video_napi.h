...
private:
    ...
    static VideoNapi *GetVideo(napi_env env, napi_callback_info info, std::shared_ptr<ContextBase> ctxt);
    static napi_value GetVideoUri(napi_env env, napi_callback_info info);
    static napi_value SetVideoUri(napi_env env, napi_callback_info info);
};
} // namespace UDMF
} // namespace OHOS
