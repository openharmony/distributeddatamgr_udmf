...
#ifndef UDMF_TEXT_NAPI_H
#define UDMF_TEXT_NAPI_H
...
private:
    ...
    static TextNapi *GetText(napi_env env, napi_callback_info info, std::shared_ptr<ContextBase> ctxt);
};
} // namespace UDMF
} // namespace OHOS
#endif // UDMF_TEXT_NAPI_H